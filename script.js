...
let App = () => {
    ...
    let ldAudio = (src) => {
        ...
        audio.currentTime = !current ? localStorage.getItem('current') : localStorage.getItem('current') === current ? current[0].id : '' ? localStorage.getItem('range') ? parseFloat(localStorage.getItem('range')) : 0 : 0
        // 
        setisloading(false)
        // setisplaying(true)
